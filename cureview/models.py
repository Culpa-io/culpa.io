...
class Course(models.Model):
    ...
    department_name = models.CharField(max_length=200) # Economics (barnard) (ECOB)
...
class ReviewableCategory(models.Model):
    ...
    directly_reviewable = models.BooleanField(default=True) # Everything except professors is directly reviewable
...
class ReviewableObject(models.Model):
    ...
    relatedCourse = models.ForeignKey(Course, on_delete=models.CASCADE, default=None, blank=True, null=True)
    relatedProfessor = models.ForeignKey(Professor, on_delete=models.CASCADE, default=None, blank=True, null=True)
...
class Review(models.Model):
    ...
    overall_rating = models.PositiveIntegerField(default=None, null=True, validators=[MinValueValidator(1), MaxValueValidator(5)])

    # What is this review about?
    target = models.ForeignKey(ReviewableObject, on_delete=models.CASCADE, null=True)
    ...
    try:
        ...
        if instance.approved:
            ...
            if instance.relatedProfessor:
                ro_prof = ReviewableObject.objects.get(relatedProfessor=instance.relatedProfessor)
